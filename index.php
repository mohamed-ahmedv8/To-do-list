                        ...
                        foreach ($todo as $item) : ?>
                            <div class="alert alert-info p-2">
                                ...
                                <div class="d-flex justify-content-between mt-3">
                                    ...
                                    <a href="handle/goto.php?st=doing&id=<?php echo $item['id'] ?>" class="btn btn-info p-1 text-white">doing</a>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
                    ...
                    <div class="show-to-do">
                        ...
                        foreach ($doing as $item) : ?>
                            <div class="alert alert-success p-2">
                                ...
                                <div class="d-flex justify-content-between mt-3">
                                    <a></a>
                                    <a href="handle/goto.php?st=done&id=<?php echo $item['id'] ?>" class="btn btn-success p-1 text-white">Done</a>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
